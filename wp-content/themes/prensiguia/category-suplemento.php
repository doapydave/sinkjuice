...
$single_cat_title = 'Suplemento';
//$themaincat = $category[0]->cat_ID;
//$single_cat_title = $category[0]->cat_name;
//$single_cat_title = "SUPLEMENTO";
echo do_shortcode('[doap_heading style="modern-1-blue" size="20" align="left" margin="0" class="fp-title-bar"]<a href="http://noticias.laprensa.com.ni/'.strtolower($single_cat_title).'/"><div class="title-left">SUPLEMENTO</div><div class="twodots"></div></a>[/doap_heading]'); 
