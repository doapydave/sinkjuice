<?php
/**
 * Plugin Name: Store Locator Plus : Icon Set SJJB
...
//
if ( ! class_exists( 'SLPIconSet_SJJB' ) ) {

    /**
    * IconSet
    *
    * @package StoreLocatorPlus\SLPIconSet_SJJB
    * @author Lance Cleveland <lance@charlestonsw.com>
    * @copyright 2013 Charleston Software Associates, LLC
    */
    class SLPIconSet_SJJB {
        public  $plugin = null;
   ...
   global $slplus_plugin;
   $slplus_plugin->IconSet['sjjb'] = new SLPIconSet_SJJB();
}