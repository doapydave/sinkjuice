            ...
            switch ($command) {
                ...
                case 'select_categorycount_for_location':
                    $sqlStatement .=
                        ...
                        'WHERE '.$this->plugin->slplus->database->info['table'].'.sl_id='.$this->plugintable['name'].'.sl_id'
                        ;
                    break;
                ...
                case 'select_where_optionvalue_has_cats':
                    $sqlStatement .=
                        'SELECT sl_id, sl_option_value FROM ' . $this->plugin->slplus->database->info['table']  . ' ' .
